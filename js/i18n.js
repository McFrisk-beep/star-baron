...
const I18n = {
  ...
  dict: {
    en: {
      ...
      "hub.hint": "Walk with arrows / WASD (or tap). Doors lead between rooms; step up to a station to open it. The tabs below still work too.",
      "hub.open": "Open {x}",
      ...
      "comms.pending": "Pending Contracts", "comms.pendingSub": "held jobs awaiting launch",
      "comms.clickOpen": "Click a message to open the conversation",
      ...
      "comms.activeMissions": "Active missions",
      "comms.cancelMission": "Cancel mission",
      "comms.launch": "Launch",
      "comms.cancelContract": "Cancel",
      "comms.viewContract": "View Contract",
      "comms.noPending": "No held contracts. View a job on the Bazaar board and Launch to take it.",
      "comms.cancelFeeNote": "Cancellation fee scales with your Baron title.",
      ...
      "auth.username": "Username", "auth.usernamePh": "letters only",
      "auth.usernameHint": "Default: {DEFAULT}. Letters A–Z only, 3–16 characters. No numbers or other scripts.",
      "auth.saveUsername": "Save username", "auth.useDefault": "Use default",
      "auth.usernameSaved": "Username saved.",
      "auth.usernameCleared": "Using your default Baron # label.",
    ...
    jp: {
      ...
      "hub.hint": "矢印／WASD（またはタップ）で移動。ドアで部屋を移動、施設に近づいて開く。下のタブも使えます。",
      "hub.open": "{x}を開く",
      ...
      "comms.dispatches": "通信", "comms.dispatchesSub": "プライベートチャンネル",
      "comms.pending": "保留契約", "comms.pendingSub": "発進待ちの契約",
      "comms.clickOpen": "メッセージをクリックして会話を開く",
      "comms.newswire": "ニュース速報", "comms.newswireLog": "ニュース速報ログ",
      "comms.ticker": "銀河ニュースを待機中…", "comms.signal": "信号を受信中…",
      "comms.activeMissions": "進行中の任務",
      "comms.cancelMission": "任務を中止",
      "comms.launch": "発進",
      "comms.cancelContract": "キャンセル",
      "comms.viewContract": "契約を見る",
      "comms.noPending": "保留中の契約はありません。バザーで契約を見て、発進で受注します。",
      "comms.cancelFeeNote": "キャンセル料は男爵称号に応じて上がります。",
