...
| `pois.js` | `POIs` — seeded deep-space points of interest in the ring between `coreSpan` and `worldSpan` (docs/SPACE_INTERACTIVITY.md §2); nothing persisted, rendered/clickable in the system scene. |
