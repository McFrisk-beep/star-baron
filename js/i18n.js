...
const I18n = {
  ...
  dict: {
    en: {
      ...
      "comms.pending": "Pending Contracts", "comms.pendingSub": "taken, not yet launched",
      ...
      "comms.noPending": "No pending contracts. Take a job on the Bazaar board, then launch it from here.",
    ...
    jp: {
      ...
      "comms.pending": "保留契約", "comms.pendingSub": "受注済み・未発進",
      ...
      "comms.noPending": "保留中の契約はありません。バザーで受注し、ここから発進できます。",
