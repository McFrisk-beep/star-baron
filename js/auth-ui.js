...
const AuthUI = {
  ...
  async doSubmit() {
    ...
    if (pass.length < 6) return this.showErr(this.t("auth.errPassLen", "Password must be at least 6 characters."));
  ...
  async doChangePassword() {
    ...
    if (pass.length < 6) return this.showChangeErr(this.t("auth.errPassLen", "Password must be at least 6 characters."));
