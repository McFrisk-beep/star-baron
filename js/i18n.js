...
const I18n = {
  ...
  dict: {
    en: {
      ...
      "nav.exchange": "Exchange", "nav.fleet": "Fleet", "nav.assets": "Assets", "nav.starmap": "Star Map", "nav.systems": "Star Systems", "nav.bazaar": "Bazaar",
      ...
      "hub.open": "Open {x}",
      "systems.title": "Star Systems", "systems.sub": "dock at capitals or claimable system hubs",
      "systems.mainHubs": "Main Hubs", "systems.systemHubs": "System Hubs",
      "exchange.title": "Galactic Exchange",
      "market.commodity": "Commodity", "market.price": "Price", "market.trend": "Trend",
      "market.stock": "Stock", "market.held": "Held", "market.pnl": "P&L", "market.trade": "Trade",
      ...
      "fleet.charters": "Active Charters", "fleet.missions": "Active Missions", "fleet.reports": "Mission Reports",
      "fleet.owned": "Owned Ships", "fleet.inventory": "Inventory",
      "comms.contractsInHand": "Contracts in hand", "comms.activeCharters": "Active charters",
      "comms.noCharters": "No hulls on charter. Dispatch one from the Bazaar → Charters tab.",
      "comms.cancelCharter": "Cancel", "comms.buyoutCharter": "Buy out",
      "industries.title": "Industries",
      "industries.permits": "Permits",
      "industries.extractors": "Extractors",
      "industries.components": "Components",
      ...
      "barons.yourTitle": "Your Title",
      "barons.ranksBtn": "All ranks",
      "barons.ranksTitle": "Baron Ranks",
      "barons.ranksClose": "Close",
      "barons.ranksYou": "you",
      "barons.tax": "Earnings tax",
      "barons.permits": "Industry permits",
      "barons.fleetCap": "Fleet cap",
      "barons.tradeCap": "Trade cap",
      "barons.startTitle": "starting title",
      "barons.fromNetWorth": "from {c}c net worth",
      ...
      "settings.tabGeneral": "General", "settings.tabMusic": "Music",
      "settings.musicNote": "Your playlist loops from the top. Pick where it starts with ★ and reorder with the arrows — saved to your game only.",
      "settings.musicEmpty": "No music in this build yet.",
      "settings.musicBackground": "Keep playing when I switch tabs",
      "settings.musicStart": "Start the loop on this song",
      "settings.musicUp": "Move up", "settings.musicDown": "Move down",
      "settings.volume": "Volume", "settings.reduced": "Reduce motion",
      "settings.reset": "Reset Save", "settings.close": "Close",
      "idle.pill": "⏸ Paused while idle — updates resume on input",
      "stale.pill": "⚠ This game is open in another tab — saving is paused here. Reload to continue in this one.",
      "settings.restore": "Restore backup",
      "settings.restoreNote": "Recovers Workshop gear and items from a wiped-save backup kept in this browser.",
      "settings.note": "Cosmocrat · saves to this browser only.",
      "btn.audioOn": "Audio on", "btn.audioOff": "Audio off",
    ...
    jp: {
      ...
      "nav.exchange": "取引所", "nav.fleet": "艦隊", "nav.assets": "資産", "nav.starmap": "星図", "nav.systems": "星系", "nav.bazaar": "バザール",
      ...
      "hub.open": "{x}を開く",
      "systems.title": "星系", "systems.sub": "首都やシステムハブにドッキング",
      "systems.mainHubs": "メインハブ", "systems.systemHubs": "システムハブ",
      "exchange.title": "銀河取引所",
      "market.commodity": "商品", "market.price": "価格", "market.trend": "傾向",
      "market.stock": "在庫", "market.held": "保有", "market.pnl": "損益", "market.trade": "取引",
      ...
      "fleet.logistics": "兵站",
      "fleet.charters": "運行中のチャーター", "fleet.missions": "進行中の任務", "fleet.reports": "任務報告",
      "fleet.owned": "所有艦", "fleet.inventory": "在庫",
      "comms.contractsInHand": "保有契約", "comms.activeCharters": "運行中のチャーター",
      "comms.noCharters": "チャーター中の艦はありません。バザー → チャーターから派遣できます。",
      "comms.cancelCharter": "解除", "comms.buyoutCharter": "買取",
      "industries.title": "産業",
      "industries.permits": "許可",
      "industries.extractors": "採掘機",
      "industries.components": "部品",
      ...
      "barons.prev": "◂ 前へ",
      "barons.next": "次へ ▸",
      "barons.yourTitle": "あなたの称号",
      "barons.ranksBtn": "全階級",
      "barons.ranksTitle": "男爵階級",
      "barons.ranksClose": "閉じる",
      "barons.ranksYou": "あなた",
      "barons.tax": "収益税",
      "barons.permits": "産業許可",
      "barons.fleetCap": "艦隊上限",
      "barons.tradeCap": "取引上限",
      "barons.startTitle": "初期称号",
      "barons.fromNetWorth": "純資産 {c}c 以上",
      "milestones.title": "実績",
      ...
      "settings.tabGeneral": "一般", "settings.tabMusic": "音楽",
      "settings.musicNote": "プレイリストは上から順にループします。★で開始曲を選び、矢印で並べ替えてください（この設定はあなたのゲームにのみ保存されます）。",
      "settings.musicEmpty": "このビルドにはまだ楽曲がありません。",
      "settings.musicBackground": "タブを切り替えても再生を続ける",
      "settings.musicStart": "この曲からループを開始",
      "settings.musicUp": "上へ", "settings.musicDown": "下へ",
      "settings.volume": "音量", "settings.reduced": "モーションを軽減",
      "settings.reset": "セーブをリセット", "settings.close": "閉じる",
      "idle.pill": "⏸ 放置中のため一時停止 — 操作すると再開します",
      "stale.pill": "⚠ このゲームは別のタブで開かれています — こちらでは保存を停止しました。続けるには再読み込みしてください。",
      "settings.restore": "バックアップを復元",
      "settings.restoreNote": "このブラウザに残っているワイプ前バックアップから、ワークショップの装備やアイテムを復元します。",
      "settings.note": "Cosmocrat · セーブはこのブラウザにのみ保存されます。",
      "btn.audioOn": "音声オン", "btn.audioOff": "音声オフ",
