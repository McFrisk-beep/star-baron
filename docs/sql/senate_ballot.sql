...
declare
  ...
  -- Full COMMODITIES list (incl. craftOnly) — matches js/senate.js ballot options.
  comms jsonb := '[{"id":"iron_ore","name":"Iron Ore"},{"id":"silicon","name":"Silicon"},{"id":"rare_earths","name":"Rare Earths"},{"id":"titanium_ore","name":"Titanium Ore"},{"id":"cobalt_ore","name":"Cobalt Ore"},{"id":"graphene_lattice","name":"Graphene Lattice"},{"id":"pulsar_shard","name":"Pulsar Shard"},{"id":"voidstone","name":"Voidstone"},{"id":"hydrogen","name":"Hydrogen"},{"id":"helium3","name":"Helium-3"},{"id":"water_ice","name":"Water Ice"},{"id":"plasma_gas","name":"Plasma Gas"},{"id":"methane_slurry","name":"Methane Slurry"},{"id":"xenon_gas","name":"Xenon Gas"},{"id":"cryo_vapor","name":"Cryo Vapor"},{"id":"quantum_foam","name":"Quantum Foam"},{"id":"foodstuffs","name":"Foodstuffs"},{"id":"synthsilk","name":"Synthsilk"},{"id":"grain","name":"Grain"},{"id":"protein_stock","name":"Protein Stock"},{"id":"hydro_greens","name":"Hydro Greens"},{"id":"algae_paste","name":"Algae Paste"},{"id":"biofiber","name":"Biofiber"},{"id":"nectar_extract","name":"Nectar Extract"},{"id":"medicinal_herbs","name":"Medicinal Herbs"},{"id":"spore_culture","name":"Spore Culture"},{"id":"nanochips","name":"Nanochips"},{"id":"antimatter","name":"Antimatter"},{"id":"fusion_cell","name":"Fusion Cell"},{"id":"sensor_array","name":"Sensor Array"},{"id":"neural_processor","name":"Neural Processor"},{"id":"quantum_core","name":"Quantum Core"},{"id":"ai_matrix","name":"AI Matrix"},{"id":"spice","name":"Spice"},{"id":"gemstones","name":"Gemstones"},{"id":"vintage_wine","name":"Vintage Wine"},{"id":"perfume_essence","name":"Perfume Essence"},{"id":"fine_art","name":"Fine Art"},{"id":"exotic_pelts","name":"Exotic Pelts"},{"id":"contraband","name":"Contraband"},{"id":"narcotics","name":"Narcotics"},{"id":"forged_credentials","name":"Forged Credentials"},{"id":"weapons_cache","name":"Weapons Cache"},{"id":"bio_toxin","name":"Bio Toxin"},{"id":"cipher_shard","name":"Cipher Shard"}]'::jsonb;
